...
- Dictated or pasted text is sent directly from the Android device to the computer address selected by the user.
- Connection profiles contain a computer name, host address, port, and authentication token. They are stored locally in the Android app's private storage.
...
Uninstalling the Android app removes its private profile data. Desktop tokens can be removed by deleting the platform-specific Whisper Bridge configuration directory after stopping the receiver.
